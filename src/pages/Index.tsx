        ...
        {activeChapter === "ch-2" && (
          <ChapterContent num="Chapter 02" arc="The Call to Adventure" title="The Vision">
            ...
            <p>
              ...
              than adoption rates for any particular product. It is about public officers having access to the best
              tools available — so that the quality of their thinking, the speed of their work, and the scope of what
              they can achieve is genuinely elevated.
            </p>
        ...
        {activeChapter === "ch-5" && (
          <ChapterContent num="Chapter 05" arc="The Journey" title="How It Works">
            <p>
              ...
              agencies run it themselves, with GovTech as backbone, not engine.
            </p>
            <PilotTimeline />
            <SuccessMetrics />
            <div className="mt-8 space-y-3">
