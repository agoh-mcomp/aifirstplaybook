...
const Chapter4 = () => (
  <ChapterContent num="Chapter 04" arc="The Foundation" title="Cultural Prerequisites">
    ...
    <div className="space-y-6 mt-8">
      {[
        { num: "01", title: "Leadership Modeling and Mandate", text: "Leaders must participate as learners, not just sponsors. When a Director builds their own AI agent, it signals that this is a legitimate investment of time. Leaders must be held accountable to build and showcase their own solution during the sprint.", icon: "👤" },
        { num: "02", title: "Permission to Invest Time", text: "Officers need explicit runway to invest the necessary time — away from BAU work — to experiment and build to reap time savings in the future. Specific BAU deliverables must be deprioritised or deferred during sprint periods. This is not about finding spare time; it's about creating it through deliberate trade-offs.", icon: "⏳" },
        { num: "03", title: "Reward Learning and Risk-Taking", text: "Experimentation must be celebrated even when solutions don't scale. Showcase attempts, lessons learned, and creative approaches — not just finished products — to signal that learning is the goal.", icon: "🏆" },
        { num: "04", title: "Start with Problems, Not Solutions", text: 'Officers must identify genuine workflow pain points before reaching for AI tools. The question is never "Where can I use AI?" but "What problem am I trying to solve?" AI becomes the implementation choice only after understanding the problem deeply.', icon: "🎯" },
        { num: "05", title: "Peer Proof Points as Inspiration", text: 'Officers need to see people like them succeed and draw inspiration for ideas. Their peers in HR, Finance, Procurement — people who had also called themselves "not technical" — showing what they built and the tangible benefits they have derived.', icon: "🤝" },
        { num: "06", title: "Sustained Engagement, Not One-Off Hackathons", text: "AI capability is a muscle that strengthens over time. SCG's three sprints over 90 days allowed officers to build confidence progressively — toe-dipping in Sprint 1, real solutions in Sprint 3. After Phase 1, SCG is now building confidence in helping corporate officers build and deploy prototypes for testing rapidly through vibe coding. Learning does not stop.", icon: "🔄" },
        { num: "07", title: "Pragmatic Data Classification", text: "Officers default to treating their work as sensitive, creating unnecessary barriers to using commercial AI tools. We must be pragmatic and willing to try commercial AI tools for non-confidential work.", icon: "📊" },
      ].map((item) => (
        <div
          key={item.num}
