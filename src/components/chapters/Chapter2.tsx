...
const Chapter2 = () => (
  <ChapterContent num="Chapter 02" arc="The Call to Adventure" title="The Vision">
    ...
    <p>
      ...
      mindset change. Instead of asking "What AI tools can I use?" ask "Can AI augment my thinking, speed up my work,
      ...
      <div className="space-y-4">
        {[
          ...
          },
          {
            ...
            text: "A reduced cycle time from problem to prototype to deployment - from months to days or hours",
            icon: Timer,
          },
          {
