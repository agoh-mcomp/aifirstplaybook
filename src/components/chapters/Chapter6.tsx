  ...
  <ChapterContent num="Chapter 06" arc="The Journey" title="How Do I Start">
    ...
    <div className="bg-surface-elevated border border-border rounded-lg p-6 md:p-8 mt-8">
      ...
      <div className="space-y-3">
        {[
          { check: "Leadership commitment", detail: "The Head of Agency has agreed to protect sprint time and participate visibly — not just endorse." },
          { check: "Nominated AI Lead", detail: "One DD-level (or above) who owns and champions the initiative." },
          { check: "Identified officers to participate", detail: "A cross-functional cohort from corporate functions — HR, Finance, Procurement, Comms, Ops." },
          ...
          { check: "Sprint support confirmed ", detail: "Sprint support, AI clinics, tool access, and deployment pathway via Rabbit Deploy." },
        ].map((item) => (
    ...
    <div className="mt-10">
      ...
      <p className="text-sm text-muted-foreground mb-6">Each month has a clear purpose, defined activities, and a tangible output.</p>
    </div>
    ...
    >
      <img src={manusWorkshopImg} alt="SCG officers at a hands-on workshop with Manus AI, learning together" className="w-full h-auto object-cover" />
    ...
    <div className="bg-surface-elevated border border-border rounded-lg p-6 md:p-8 mt-10">
      ...
      <div className="space-y-4">
        {[
          ...
          { tip: "Make Sprint low-stakes to build confidence.", detail: "The goal is toe-dipping, not transformation. Let officers explore, fail safely, and build confidence before raising the bar." },
          { tip: "Showcase learning — not just successes.", detail: "The team that tried and learned something is as valuable as the team that shipped. Celebrate both." },
          { tip: "Document as you go.", detail: "Your agency playbook should be written during the sprint, not after. Capture decisions, friction points, and workarounds as you sprint." },
        ].map((item) => (
