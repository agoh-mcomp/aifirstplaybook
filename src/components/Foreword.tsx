  ...
  return (
    <div>
      ...
      <div className="mb-12">
        ...
        <h1 className="font-display text-4xl md:text-5xl text-foreground mt-3 leading-tight">A Message to Leaders</h1>
      ...
      <div className="space-y-6 text-lg leading-relaxed text-secondary-foreground font-body">
        ...
        <p>
          But here's what I really want you to know: the hardest part was never the technology. It was letting go of old
          habits, of the need for everything to be perfect before we tried, of the instinct to delegate "innovation" to
          someone else's team.
        </p>

        <p>
          This playbook is everything we learned, written down so you don't have to start from scratch. It's not theory.
          It's what actually worked and what didn't inside a government agency with all the usual constraints you know
          well.
        </p>

        <p className="text-foreground font-medium">If I could ask you for just four things:</p>
        ...
        <div className="space-y-5 pl-1">
          {[
            ...
            >
              ...
              <p>
                <span className="text-foreground font-semibold">{item.bold}</span> {item.text}
              </p>
            </motion.div>
          ))}
        </div>
